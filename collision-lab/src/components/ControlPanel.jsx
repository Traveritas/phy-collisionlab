  ...
  return (
    <div>
      ...
      <Row gutter={16} align="middle" style={{ marginTop: 12 }}>
        <Col span={6}>阻力:</Col>
        <Col span={6}>
          <Slider min={0} max={0.2} step={0.01} value={params.frictionAir} onChange={v => handleChange('frictionAir', v)} disabled={running} style={{ width: 100 }} />
        </Col>
        <Col span={6}>恢复系数:</Col>
        <Col span={6}>
          <Select
